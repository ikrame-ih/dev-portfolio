...
// Stroke icons from Lucide (ISC) for concepts that have no brand mark.
const FROM_LUCIDE = {
  LLMs: Brain,
...
export const StackIcon = ({
  ...
  const Lucide = FROM_LUCIDE[key];
  if (Lucide) return <LucideMark Icon={Lucide} className={className} />;
